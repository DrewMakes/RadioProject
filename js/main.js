...
(function() {
  var Mp3Queue = function(audioEle1, audioEle2, tracks) {
    ...
    if (!audioEle1 || !audioEle1.tagName || audioEle1.tagName !== "AUDIO")
      throw "Invalid audio element1";
    if (!audioEle2 || !audioEle2.tagName || audioEle2.tagName !== "AUDIO")
  ...
  var programData = [
    {
      ...
      src: "tracks/Band of Gold - Freda Payne.mp3",
      dur: 21263,
      outtro: 19552
    },
    {
      ...
      src:
        "https://docs.google.com/uc?export&id=1k6oDgptW4QGhHTVMtWPwvMjQ2IrkN2DI",
      dur: 4389,
      outtro: 0
    },
    {
      ...
      src:
        "https://docs.google.com/uc?export&id=18svt957rvxO_J-xj5PgS9ebQLERxPFVz",
      dur: 3384,
      outtro: 2320
    },
    {
      ...
      src:
        "https://docs.google.com/uc?export&id=14sOy7t-ylF7PvdxNQrJ8VBqE7N9ed53O",
      dur: 7344,
      outtro: 0
    }
  ];
